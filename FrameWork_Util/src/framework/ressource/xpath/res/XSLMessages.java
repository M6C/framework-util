...
/**
 * <meta name="usage" content="internal"/> Sets things up for issuing error messages.  This class is misnamed, and should be called XalanMessages, or some such.
 */
public class XSLMessages
{
  ...
  private static final String XSLT_ERROR_RESOURCES = "framework.ressource.xpath.res.XSLTErrorResources";

  /** The class name of the XPath error message string table.     */
  private static final String XPATH_ERROR_RESOURCES = "framework.ressource.xpath.res.XPATHErrorResources";
